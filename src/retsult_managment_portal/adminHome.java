...
public class adminHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setBackground(new java.awt.Color(231, 110, 79));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Mechanical", "C.S", "Civil", "Others" }));
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons&bgs/icons8-save-24.png"))); // NOI18N
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try{
            ...
            st.executeUpdate("insert into student(rollno,course,branchName,name,gender,father) values('"+roll+"','"+course+"','"+branchName+"','"+name+"','"+gender+"','"+fatherName+"')");
